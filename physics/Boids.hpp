...
namespace Core
{
    ...
    public:
        ...
        float getmaxSteering() const { return m_maxSteering; }

        void setRadiusAlignment(float alignment) { m_radiusAlignment = alignment; }
        float getRadiusAlignment() const { return m_radiusAlignment; }

        void setRadiusCohesion(float cohesion) { m_radiusCohesion = cohesion; }
        float getRadiusCohesion() const { return m_radiusCohesion; }

        void setRadiusSeparation(float separation) { m_radiusSeparation = separation; }
        float getRadiusSeparation() const { return m_radiusSeparation; }
        ...
        bool getSteering() const { return m_activeSteering; }
