...
void Boids::reset()
{
  ...
  m_clContext.acquireGLBuffers({ "boidsColor", "boidsPos" });
  ...
  m_clContext.releaseGLBuffers({ "boidsColor", "boidsPos" });
}
...
void Boids::update()
{
  ...
  m_clContext.acquireGLBuffers({ "boidsPos" });
  ...
  m_clContext.releaseGLBuffers({ "boidsPos" });
}